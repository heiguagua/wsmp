 ...
 * 2017-09-29T14:47:08.213+08:00
 * Generated source version: 3.1.12
 * 
 */
@WebServiceClient(name = "FreqWarningWebService", 
                  wsdlLocation = "http://192.168.21.108:8192/FreqWarningWebService.asmx?wsdl",
...
public class FreqWarningWebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.21.108:8192/FreqWarningWebService.asmx?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(FreqWarningWebService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://192.168.21.108:8192/FreqWarningWebService.asmx?wsdl");
        }
        WSDL_LOCATION = url;
    }
