 ...
 * 2017-12-05T13:51:32.991+08:00
 * Generated source version: 3.1.12
 * 
 */
@WebServiceClient(name = "FreqService", 
                  wsdlLocation = "http://192.168.21.100:7180/ws/services/FreqService?wsdl",
...
public class FreqService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.21.100:7180/ws/services/FreqService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(FreqService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://192.168.21.100:7180/ws/services/FreqService?wsdl");
        }
        WSDL_LOCATION = url;
    }
