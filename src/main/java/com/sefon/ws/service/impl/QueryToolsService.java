 ...
 * 2017-12-05T13:52:09.497+08:00
 * Generated source version: 3.1.12
 * 
 */
@WebServiceClient(name = "QueryToolsService", 
                  wsdlLocation = "http://192.168.21.100:7180/ws/services/QueryToolsService?wsdl",
...
public class QueryToolsService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.21.100:7180/ws/services/QueryToolsService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(QueryToolsService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://192.168.21.100:7180/ws/services/QueryToolsService?wsdl");
        }
        WSDL_LOCATION = url;
    }
