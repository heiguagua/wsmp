 ...
 * 2017-08-10T14:23:12.594+08:00
 * Generated source version: 3.1.11
 * 
 */
@WebServiceClient(name = "StationService", 
                  wsdlLocation = "http://192.168.21.105:7080/ws/services/StationService?wsdl",
...
public class StationService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://192.168.21.105:7080/ws/services/StationService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(StationService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://192.168.21.105:7080/ws/services/StationService?wsdl");
        }
        WSDL_LOCATION = url;
    }
