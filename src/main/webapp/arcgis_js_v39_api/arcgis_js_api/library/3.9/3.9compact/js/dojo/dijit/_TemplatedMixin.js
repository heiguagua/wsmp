...
define("dijit/_TemplatedMixin", "dojo/cache dojo/_base/declare dojo/dom-construct dojo/_base/lang dojo/on dojo/sniff dojo/string ./_AttachMixin".split(" "), function (m, n, g, h, p, q, l, r) {
    var e = n("dijit._TemplatedMixin", r, {
        templateString: null,
        templatePath: null,
        _skipNodeCache: !1,
        ...
        _stringRepl: function (a) {
            ...
            return l.substitute(a, this, function (a, c) {
                ...
                return null ==
                a ? "" : "!" == c.charAt(0) ? a : a.toString().replace(/"/g, "\x26quot;")
            }, this)
        },
        buildRendering: function () {
            if (!this._rendered) {
                ...
                if (h.isString(a)) {
                    if (b = g.toDom(this._stringRepl(a), this.ownerDocument), 1 != b.nodeType)throw Error("Invalid template: " + a);
    ...
    e.getCachedTemplate = function (a, b, d) {
        ...
        if (f) {
            try {
                if (!f.ownerDocument || f.ownerDocument == (d || document))return f
            } catch (h) {
            }
            g.destroy(f)
        }
        a = l.trim(a);
        if (b || a.match(/\$\{([^\}]+)\}/g))return k[c] = a;
        b = g.toDom(a, d);
