...
<body id='waveOrder'>
  ...
  <!-- Modal Signal-->
  <div class="modal fade" id="modalSignal" tabindex="-1" role="dialog" aria-labelledby="modalSignalLabel">
  ...
  <!-- Modal Signal-->
  <div class="modal fade" id="modalEvaluate" tabindex="-1" role="dialog" aria-labelledby="modalEvaluateLabel">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
