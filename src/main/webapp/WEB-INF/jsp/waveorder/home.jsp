...
<div class="tab-content">
    ...
    <div role="tabpanel" class="tab-pane" id="dealed">
      <table class="table table-striped text-center" id='table-alarm-dealed'>
      </table>
    </div>
  </div>
      ...
      <section class='flex-row'>
        <div class='box'>
          <div class='signal-wrap'><label class='signal-detect'>信号监测</label>
            <ul class='signal-category'>
              <li class='item'>
                <div class="checkbox checkbox-primary">
                        <input id="legal-check" class="styled" type="checkbox" checked="checked">
                        <label for="legal-check">
                            合法信号
                        </label>
              ...
              <li class='item'>
                <div class="checkbox checkbox-primary">
                        ...
                        <label for="legal-wrong-check">
                            合法违规
                        </label>
                    </div>
                <span class='signal-sign legal-wrong'></span><span class='number legal-wrong-number'>198</span></li>
              <li class='item'>
                <div class="checkbox checkbox-primary">
                        <input id="known-check" class="styled" type="checkbox" >
                        <label for="known-check">
                            已知信号
                        </label>
                    </div>
                <span class='signal-sign known'></span><span class='number known-number'>198</span></li>
              <li class='item'>
                <div class="checkbox checkbox-primary">
                        <input id="illegal-check" class="styled" type="checkbox" >
                        <label for="illegal-check">
                            非法信号
                        </label>
                    </div>
                <span class='signal-sign illegal'></span><span class='number illegal-number'>3</span></li>
              <li class='item'>
                <div class="checkbox checkbox-primary">
                        <input id="unknown-check" class="styled" type="checkbox" >
                        <label for="unknown-check">
                            不明信号
                        </label>
                    </div>
    ...
    <!-- Modal Station-->
<div class="modal fade" id="modalStation" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
