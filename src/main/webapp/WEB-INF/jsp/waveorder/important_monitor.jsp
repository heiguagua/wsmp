	...
	<div class="form-box-wrap">
		<div class="form-group col-sm-6">
			...
			<div class=' input-group date time-picker'  style="padding-left:15px">
				<input title="不能为空" required id='startTime' name="beginTime" type='text' class="form-control " value="${dto.getBeginTime()}" />
		...
		<div class="form-group col-sm-6">
			...
			<div class='input-group date time-picker'  style="padding-left:15px">
				<input title="不能为空" required id='endTime' name="endTime" type='text' class="form-control " value="${dto.getEndTime()}"/>
		          <span class="input-group-addon">
		            <span class="glyphicon glyphicon-calendar"></span>
		          </span>
			</div>
