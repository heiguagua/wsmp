 ...
 <div class='signal-wrap'>
          ...
          <ul class='signal-category' style="position: absolute;right: 130px;">
            ...
            <li class='item'>
              ...
              </div> <span class='signal-sign legal-wrong' title="合法违规信号"></span> <span class='number legal-wrong-number' title="合法违规信号">${redio.legalUnNormalStationNumber}</span>
            </li>
            <li class='item'>
              <div class="radio radio-primary  ">
                <input type="radio" name="signal-type" id="otherStation" title="已知信号" value="2" isSubType="false">
                <label for="otherStation"> 已知信号</label>
              </div> <span class='signal-sign known' title="已知信号"></span> <span class='number known-number' title="已知信号">${redio.konwStationNumber}</span>
            </li>
            <li class='item'>
              <div class="radio radio-primary  ">
                <input type="radio" name="signal-type" id="illegal" title="非法信号" value="3" isSubType="false">
                <label for="illegal"> 非法信号</label>
              </div> <span class='signal-sign illegal' title="非法信号"></span> <span class='number illegal-number' title="非法信号">${redio.illegalSignal}</span>
            </li>
            <li class='item'>
              <div class="radio radio-primary  ">
                <input type="radio" name="signal-type" id="unknown" title="不明信号" value="4" isSubType="false">
                <label for="unknown"> 不明信号</label>
              </div> <span class='signal-sign unknown' title="不明信号"></span> <span class='number unknown-number'  title="不明信号">${redio.unKonw}</span>
            </li>
          </ul>
