...
<body id='signal'>
	...
	<div class='header-bar'>
		...
		<div class='header-search'>
			<input id='search' type='text' /> <span class='search-icon'></span>
		...
		<span id="signal_list1"> <select
			class='station-list select2-picker'>
		</select>
		</span> <span id="station_list"> <select
			class='station-list select2-picker'>
		</select>
		</span>

		<div class='config pull-right'>
			<a class='btn btn-default btn-config'> <img
				src='images/export.png' />&nbsp;&nbsp;导出报表
	...
	<!-- Modal 小时场强度-->
	<div class="modal fade" id="modalHour" tabindex="-1" role="dialog"
		aria-labelledby="modalHourLabel">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
	...
	<script type="text/javascript">
		require([ "home/signal/signal_map_init", "jquery", "dojo/domReady!" ],
				function(init) {
					require([ "bootstrap", "echarts", "select2",
							"home/signal/signal_manage" ], function(bootstrap,
							echarts, select2, signal_manage) {
						signal_manage.init();
						var map = init.init();
					})
