define([ "ajax", "echarts", "jquery" ], function(ajax, echarts, jquery) {
    ...
    function spectrum_player() {
        ...
        var total_data = spectrum_play_list.length;
    ...
    function load_play_control(total_data){
      var playState = true;
      // 播放暂停控制
      $(".spectrum-play-control .play").on("click",function(){
        var $play_state = $(this);
        playState = !playState;
        if(!playState){
      ...
      // 播放上一条
      $(".spectrum-play-control .backward").on("click",function(){
      ...
      // 播放下一条
      $(".spectrum-play-control .forward").on("click",function(){
