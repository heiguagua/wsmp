define(["jquery", "bootstrap", "echarts", "ajax"], function(jquery, bootstrap, echarts, ajax) {
    ...
    function spectrum_player() {
        ...
        console.log(spectrum_play_list);
        var play_data = spectrum_play_list;
        var x_data = [];
        var timeline_data = [];
        for (var i = 0; i < play_data.length; i++) {
            console.log(play_data[i]);
            x_data.push(play_data[i].freqData);
            timeline_data.push(i + 1);
        }
        //        var y_data = [{
    ...
    function load_spectrum_data() {
        ...
        var beginTime = $('#signal_list1').find('option:selected').attr("beginTime");
        var endTime = $('#signal_list1').find('option:selected').attr("endTime");
        var url = "data/asiq/spectrum/" + 52010118 + "/" + 101700000 + "/" + 1501650012000 + "/" + 1501650012000;
        require(["bootstrap", "bootstrapTable"], function() {
            require(["bootstrap_table_cn"], function() {
                $('#spectrum-table').bootstrapTable({
                    ...
                    responseHandler : function(res) {
                        console.log(res);
                        var datas = {};
                        datas.total = res.length;
                        datas.rows = res;
                        //spectrum_play_list = datas;
                        return datas;
                    },
                    columns : [{
                        checkbox : true,
    ...
    function load_audio_data() {
        ...
        //			require(["home/signal/audio_player",function(WaveSurfer){
