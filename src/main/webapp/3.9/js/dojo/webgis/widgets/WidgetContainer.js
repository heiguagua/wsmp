define(["dojo/_base/declare", "dojo/_base/array", "dojo/query", "dojo/topic", "dojo/dom-style", "dojo/on", "dojo/fx", "dojo/_base/fx", "dojo/_base/lang", "dojo/dom-attr", "dojo/dom-class", "dojo/dom-geometry", "dojo/NodeList-fx",
    "./ContainedWidgetFrame", "dijit/_Widget", "dijit/_Container", "dojo/dnd/Moveable", "dijit/_TemplatedMixin", "dojo/text!./template/WidgetContainer.html"],
        ...
        return declare([_Widget, _TemplatedMixin, _Container], {
            ...
            startup: function () {
                ...
                for (var i = 0; i < children.length; i++) {
                    on(children[i], "ResizeStart", lang.hitch(this, "frameResizing"));
                    on(children[i], "Close", lang.hitch(this, "closeWidget"));
                    on(children[i], "ResizeEnd", lang.hitch(this, "ensureFrameIsVisible"));
                }
