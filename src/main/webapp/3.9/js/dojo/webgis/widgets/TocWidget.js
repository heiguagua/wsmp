define(["dojo/_base/declare", "dojo/_base/array", "dojo/query", "dojo/dom-attr", "dojo/dom-style", "dojo/on", "dojo/_base/lang",
    "dijit/form/CheckBox", "./_BaseWidget", "dijit/_WidgetsInTemplateMixin", "dojo/text!./template/TocWidget.html", "dijit/form/HorizontalSlider"],
    function (declare, array, query, domAttr, domStyle, on, lang, CheckBox, _BaseWidget, _WidgetsInTemplateMixin, template) {
        return declare([_BaseWidget, _WidgetsInTemplateMixin], {
            ...
            buildLayerList: function (layer) {
                ...
                var currentHTML = "";
                var expandImageUrl = require.toUrl("webgis/widgets/assets/images/expand.bmp");
                var blankImageUrl = require.toUrl("webgis/widgets/assets/images/blank.bmp");
            ...
            toggleLayer: function (evt) {
                ...
                if (layerDiv.style.display == 'block') {
                    icon.src = require.toUrl("webgis/widgets/assets/images/expand.bmp");
                    layerDiv.style.display = 'none';
                }
                else {
                    icon.src = require.toUrl("webgis/widgets/assets/images/close.bmp");
